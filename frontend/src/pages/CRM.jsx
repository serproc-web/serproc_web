            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-slate-900/50 backdrop-blur-xl rounded-2xl p-5 border border-white/5">
                ...
                <div>
                  ...
                  >
                    <option value="day" className="bg-slate-800 text-white">Por día</option>
                    <option value="week" className="bg-slate-800 text-white">Por semana</option>
                    <option value="month" className="bg-slate-800 text-white">Por mes</option>
                  </select>
                </div>
                <div>
                  ...
                  >
                    ...
                    <option value="completado" className="bg-slate-800 text-white">Completado</option>
                  </select>
                </div>
              </div>
